...
export function FinalCta() {
  ...
  return (
    <Section labelledBy="final-cta-title">
      <Container>
        <Reveal className="relative overflow-hidden rounded-[2rem] bg-gradient-to-br from-[#0d9488] via-[#0f766e] to-[#0c3a47] px-6 py-12 text-white shadow-pop sm:px-12 sm:py-14">
          <div aria-hidden="true" className="pointer-events-none absolute inset-0">
            <div className="auth-blob absolute -top-24 -right-16 h-72 w-72 rounded-full bg-[#34d399]/30 blur-3xl" />
            <div className="auth-blob absolute -bottom-28 -left-10 h-72 w-72 rounded-full bg-[#fbbf24]/20 blur-3xl [animation-delay:-8s]" />
          </div>
